...
$(function() {
  ...
  $('.wy-menu-vertical li.current > a').first().on('click', function () {
      $(this).toggleClass('current').parent().toggleClass('current')
      event.preventDefault()
  })

  $('.wy-menu-vertical li.current .subnav > li > a').on('click', function () {
...
//     var elements = $('.section [id]').filter(function (index, el) {
//         return pageYOffset >= el.offsetTop
//     })
//     // console.log(elements)
//     var id = elements.last().attr('id')
//     if (!id) return
//     // location.hash = '#' + id
//     // $('.wy-menu-vertical li.current').last().removeClass('current')
//     // $('a[href="#'+ id +'"]').addClass('current').parent().addClass('current')
// })
